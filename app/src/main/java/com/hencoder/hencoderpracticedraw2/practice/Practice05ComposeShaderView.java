...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader shader1 = new BitmapShader(BitmapFactory.decodeResource(getResources(),R.drawable.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader comShader = new ComposeShader(shader,shader1, PorterDuff.Mode.DST_IN);
        paint.setShader(comShader);
    }
